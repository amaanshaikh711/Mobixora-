    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="grid lg:grid-cols-2 gap-8 mb-12">
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-2xl flex items-center justify-center overflow-hidden border border-gray-200" style={{ aspectRatio: '3/4', background: '#f8f9fa' }}>
            <img
          ...
          <div className="flex gap-3 overflow-x-auto hide-scrollbar">
            {product.images.map((img, idx) => (
              <button
                ...
                className={`shrink-0 w-20 h-20 rounded-xl overflow-hidden border-2 transition ${idx === selectedImage
        ...
        <div>
            ...
            <div className="flex gap-2">
              {product.colors.map((color, idx) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm rounded-lg border-2 font-medium transition ${idx === selectedColor
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className={`flex-1 py-3.5 rounded-lg font-bold text-sm transition ${isInCart(product.id)
